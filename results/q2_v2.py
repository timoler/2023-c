...
for col in expert_cols:
    ...
    if len(valid) > 10:
        ...
        print(f'{col}: mu={expert_stats[col][\
mu\]:.2f}, sigma={expert_stats[col][\sigma\]:.2f}, n={len(valid)}')
...
# Validation
if len(df_std) > 100:
    corr = stats.spearmanr(df_std['standard_score'].rank(), df_std['standard_score'])[0]
    print(f'Spearman self-corr (sanity): {corr:.4f}')
